...
const Footer = ({ currentPage, setPage, theme, setFormContextChanger }) => {
    ...
    const pages = [
        ...
        { id: "vehicals", label: "Vehicals", icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h12a2 2 0 002-2v-4a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a2 2 0 01-2 2z" /></svg> },
    ];
